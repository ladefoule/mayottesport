...
<div class="p-lg-3">
    <div class="row m-0 pt-3 bg-white">
        ...
        <form action="" method="POST" class="needs-validation d-flex flex-wrap p-0" id="formulaire">
            @csrf
            ...
            <div class="col-12 pb-3">
                ...
                <input id="href_fil_actu" type="text" name="href_fil_actu" class="form-control input-optionnel" value="{{ old('href_fil_actu') }}">
            </div>
...
@section('section-droite')
    <div class="my-3 text-center p-3 bg-white">
