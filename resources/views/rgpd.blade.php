...
@section('content')
<div class="p-lg-3">
    <div class="col-md-10 bg-white col-lg-9 col-xl-8 m-auto p-3 shadow-div">
        <div class="col-12 p-0" id="politique" style="font-size: 1rem">
            <div>
            ...
            <div>
                ...
                <p>
                    Notre site web utilise des cookies. Un cookie est un fichier contenant un identifiant (une chaîne de lettres et de chiffres) envoyé par un serveur web vers un navigateur web et stocké par le navigateur.
                </p>
                <p>
                ...
                <ul>
                    <li>Nous utilisons Google Analytics et Adwords sur notre site web pour : 
                        <ul>
                            ...
                            <li>envoyer des publicités ciblées pouvant intéresser certains utilisateurs (décrivez vos autres objectifs);</li>
                            </li>
                        </ul>
                </ul>
            </div>
