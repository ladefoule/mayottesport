...
{{-- NAVBAR LARGE SCREEN --}}
<nav class="navbar fixed-top navbar-light navbar-expand-lg @if(in_array(request()->route()->getName(), ['sport.index', 'competition.index', 'competition.classement', 'competition.calendrier-resultats', 'competition.palmares'])) border-bottom-sport @else border-bottom-defaut @endif bg-white p-0">
   <div class="container">
