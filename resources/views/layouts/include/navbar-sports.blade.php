...
{{-- NAVBAR LARGE SCREEN --}}
<nav class="navbar fixed-top navbar-light navbar-expand-lg @if(in_array(request()->route()->getName(), ['sport.index', 'competition.index'])) border-bottom-sport @else border-bottom-defaut @endif bg-white p-0">
   <div class="container">
