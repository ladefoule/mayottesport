...
<footer class="col-12 footer font-small indigo text-white h-auto bg-dark mt-auto">
    ...
    <div class="row footer-social justify-content-center py-2 border-top border-secondary">
        ...
        <a target="_blank" href="{{ asset('feed') }}" class="mx-3"><img src="{{ asset('storage/img/icons/flux-rss.png') }}" alt="S'abonner aux flux rss" title="S'abonner aux flux rss" class="img-fluid bg-dark"></a>
    </div>
    <!-- Social buttons -->
