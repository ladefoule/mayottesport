...
Route::get('/{sport}/{competition}/{annee}/calendrier-et-resultats/journee-{journee}', 'CompetitionController@resultats')->name('competition.calendrier-resultats');
Route::get('/{sport}/{competition}/{annee}/calendrier-et-resultats.html', 'CompetitionController@resultatsSaison')->name('competition.saison.calendrier-resultats');
